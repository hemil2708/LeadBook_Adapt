...
class AdaptDownloaderMiddleware:
    ...
    def process_request(self, request, spider):
        ...
        current_proxy = str(random.choice(proxy)).split(":")
        request.meta['proxy'] = "http://zproxy.lum-superproxy.io:22225/"
        # request.meta['proxy'] = "https://108.59.14.200:13202"
        # request.meta['proxy'] = "https://108.59.14.200:13202"
        # request.meta['proxy'] = "https://proxymesh.com/auth/login/"
        request.headers['Proxy-Authorization'] = basic_auth_header(current_proxy[0], current_proxy[1])
        return None
